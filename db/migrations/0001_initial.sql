-- GitPulse vNext PostgreSQL bootstrap schema
-- Phase: rewrite bootstrap
-- Notes:
-- - preserves the current SQLite table intent while upgrading types for PostgreSQL
-- - does not imply runtime parity yet
...
CREATE TABLE IF NOT EXISTS repositories (
    id UUID PRIMARY KEY,
    target_id UUID REFERENCES tracked_targets(id),
    name TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_repo_status_snapshots_repo_observed_at
...
CREATE INDEX IF NOT EXISTS idx_file_activity_events_repo_observed_at
